    ...
    <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-5xl lg:text-8xl font-black text-slate-900 mb-8 tracking-tight leading-[0.95]">
          ...
          <span className="gradient-text">The Unconnected.</span>
        </h1>
        
        <p className="text-xl lg:text-2xl text-slate-600 max-w-3xl mx-auto mb-12 leading-relaxed font-medium">
          If your business isn't online, it doesn't exist. WebCore takes local companies 
          from invisible to <span className="text-slate-900 font-bold underline decoration-cyan-400 underline-offset-4">unstoppable</span> with custom digital solutions.
        </p>
